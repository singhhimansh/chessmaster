...
import chessboard from '../public/images/chess.webp';
...
const Home: NextPage = () => {
  ...
  return (
    <div className={`flex min-h-screen flex-col items-center justify-center py-2 ${darkMode}`}  >
      <Head>
          ...
          <div className="flex flex-col lg:flex-row lg:px-20 gap-5 justify-between items-center z-10 w-full text-white lg:py-4">
            <div className="flex flex-row items-center justify-between w-full md:justify-around">
              <div className="flex flex-col justify-between items-center w-auto px-5 gap-5">
                <a className="z-10 block text-xl lg:text-3xl font-bold bg-gradient-to-br from-golden to-white bg-clip-text text-transparent" href="/">Chesslers</a>
              </div>
            </div>

            <div className="flex justify-around lg:w-auto w-full py-4 lg:py-0 items-center space-x-14 text-sm lg:text-lg px-2">
              <div className="md:w-60">
                <button className="p-2 flex duration-1000 justify-end  w-full  w-0 h-0  duration-1000 p-0">
                  <svg width="27" height="27" viewBox="0 0 27 27" className="h-5 w-5 text-gray-200 " xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M12.6897 0C19.6868 0 25.3782 5.69142 25.3782 12.6884C25.3782 15.9896 24.1113 19.0004 22.0382 21.2601L26.1175 25.3309C26.4993 25.7127 26.5006 26.3303 26.1188 26.712C25.9286 26.9049 25.6771 27 25.4269 27C25.178 27 24.9279 26.9049 24.7363 26.7146L20.6078 22.5976C18.436 24.3369 15.6823 25.3782 12.6897 25.3782C5.69273 25.3782 0 19.6854 0 12.6884C0 5.69142 5.69273 0 12.6897 0ZM12.6897 1.95447C6.77029 1.95447 1.95447 6.76899 1.95447 12.6884C1.95447 18.6079 6.77029 23.4237 12.6897 23.4237C18.6079 23.4237 23.4237 18.6079 23.4237 12.6884C23.4237 6.76899 18.6079 1.95447 12.6897 1.95447Z" fill="currentColor"></path>
                  </svg>
                </button>
                <div className="relative">
                  <div className="relative w-full  cursor-default overflow-hidden delay-500 duration-1000   focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
                    ...
                    <input className="text-sm rounded-lg block w-full pl-10 p-1 bg-primary border-gray-600 outline-none placeholder-gray-400 text-white" placeholder="Search" id="headlessui-combobox-input-:r1:" onChange={()=> console.log('searching')
                    } role="combobox" type="text" aria-expanded="false" data-headlessui-state="" value="" />
                  </div>
                </div>
              </div>
              <div className="flex gap-5">
                <a className="font-semibold hover:text-golden hover:underline underline-offset-4 duration-500 ease-in" href="/leaderboard">Leaderboard</a>
                <div className="rounded-lg text-sm w-32 px-3 font-bold bg-golden text-primary ">
                  <a href="" className="flex items-center justify-center w-full">
                    <p>Login with</p>
                    <svg height="30" viewBox="-12 -12 74 74" xmlns="http://www.w3.org/2000/svg"><path fill="#000000" stroke="#000000" strokeLinejoin="round" d="M38.956.5c-3.53.418-6.452.902-9.286 2.984C5.534 1.786-.692 18.533.68 29.364 3.493 50.214 31.918 55.785 41.329 41.7c-7.444 7.696-19.276 8.752-28.323 3.084C3.959 39.116-.506 27.392 4.683 17.567 9.873 7.742 18.996 4.535 29.03 6.405c2.43-1.418 5.225-3.22 7.655-3.187l-1.694 4.86 12.752 21.37c-.439 5.654-5.459 6.112-5.459 6.112-.574-1.47-1.634-2.942-4.842-6.036-3.207-3.094-17.465-10.177-15.788-16.207-2.001 6.967 10.311 14.152 14.04 17.663 3.73 3.51 5.426 6.04 5.795 6.756 0 0 9.392-2.504 7.838-8.927L37.4 7.171z"></path>
                    </svg>
                  </a>
                </div>
              </div>
            ...
            <div className="flex-1 md:w-auto w-screen text-white px-5 md:px-20 xl:px-40 py-10 ">
                ...
                <div className="tilter">
                  <div className="slideContent h-full">
                    <div className="relative md:mt-20">
                      <Image alt="board" src={chessboard} decoding="async" data-nimg="1" loading="lazy" style={{color: "transparent"}} width="600" height="300" />
                      <div className="absolute top-6 left-10 md:top-10 md:left-20 rotate-12 hover:rotate-0 h-20 w-20 md:h-40 md:w-40">
                        <Image alt="board" src={king} sizes="100vw" decoding="async" data-nimg="fill" loading="lazy" style={{position: "absolute", height: "100%", width: "100%", inset: "0px", color: "transparent"}} />
                      </div>
                      <div className="absolute top-10 right-10 md:top-10 md:right-10 -rotate-12 hover:rotate-0 h-20 w-20 md:h-40 md:w-40 ">
                        <Image alt="board" sizes="100vw" src={pawn} decoding="async" data-nimg="fill" loading="lazy" style={{position: "absolute", height: "100%", width: "100%", inset: "0px", color: "transparent"}} />
                      </div>

                      <div className="absolute -top-5 right-24 md:-top-10 md:right-56 -rotate-12 hover:rotate-0 h-20 w-20 md:h-40 md:w-40">
                        <Image alt="board" sizes="100vw" src={knight} decoding="async" data-nimg="fill" loading="lazy" style={{position: "absolute", height: "100%", width: "100%", inset: "0px", color: "transparent"}} />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="flex flex-col items-center gap-20 my-40">
                ...
                <div className="flex flex-col md:flex-row gap-16 justify-around w-full">
                  <div className=" bg-golden/20 rounded-lg p-5 py-8 w-80 relative flex flex-col items-center gap-4">
                    <p className="absolute left-2 -top-10 text-6xl font-extrabold text-golden/30">1</p>
                    <div className="flex items-center gap-2">
                      <svg viewBox="-12 -12 74 74" xmlns="http://www.w3.org/2000/svg" className="h-14 text-golden"><path fill="none" stroke="currentColor" strokeLinejoin="round" d="M38.956.5c-3.53.418-6.452.902-9.286 2.984C5.534 1.786-.692 18.533.68 29.364 3.493 50.214 31.918 55.785 41.329 41.7c-7.444 7.696-19.276 8.752-28.323 3.084C3.959 39.116-.506 27.392 4.683 17.567 9.873 7.742 18.996 4.535 29.03 6.405c2.43-1.418 5.225-3.22 7.655-3.187l-1.694 4.86 12.752 21.37c-.439 5.654-5.459 6.112-5.459 6.112-.574-1.47-1.634-2.942-4.842-6.036-3.207-3.094-17.465-10.177-15.788-16.207-2.001 6.967 10.311 14.152 14.04 17.663 3.73 3.51 5.426 6.04 5.795 6.756 0 0 9.392-2.504 7.838-8.927L37.4 7.171z"></path></svg>
              ...
              <div className="flex flex-col my-40 gap-10 items-center">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  <Image alt="mesh" src="" decoding="async" data-nimg="1" loading="lazy" style={{ color: "transparent" }} width="180" height="100" />
                  <Image alt="tachyon" src="" decoding="async" data-nimg="1" loading="lazy" style={{color: "transparent"}} width="250" height="130"/>
                  <Image alt="protocol" src="" decoding="async" data-nimg="1" loading="lazy" style={{color: 'transparent',}} width="250" height="130" />
                </div>
              </div>
              <div className="flex flex-col my-40 gap-10 items-center">
